var _interopRequireDefault = require("../../@babel/runtime/helpers/interopRequireDefault"), _defineProperty2 = require("../../@babel/runtime/helpers/defineProperty"), _typeof2 = require("../../@babel/runtime/helpers/typeof"), _base = require("base64"), _md = _interopRequireDefault(require("md5")), util = {};
...
util.base64_encode = function(e) {
...
}, util.numFormat = function(e) {
    return e.toLocaleString();
}, util.islogin = function() {
    try {
        var e = wx.getStorageSync("memberinfo");
        return console.log("memberinfo", e), e.id ? (console.log("已经登陆"), !0) : (console.log("没有登陆"), 
        !1);
    } catch (e) {
        return console.log("没有登陆"), !1;
    }
    ...
    e[2] && (a += "do=" + e[2] + "&")), t && "object" === _typeof2(t)) for (var r in t) r && t.hasOwnProperty(r) && t[r] && (a += r + "=" + t[r] + "&");
    return a;
    ...
    }, _defineProperty2(t, "header", {
        "content-type": "application/x-www-form-urlencoded"
    }), _defineProperty2(t, "success", function(t) {
    ...
    }), _defineProperty2(t, "fail", function(t) {
    ...
    }), _defineProperty2(t, "complete", function(t) {
    ...
    var t = function() {
        ...
        wx.login({
            success: function(n) {
                console.log("res", n), util.request({
                    ...
                    cachetime: 0,
                    success: function(n) {
                        console.log("session", n), n.data.errno || (t.sessionid = n.data.data.sessionid, 
    ...
    this.isLeapYear = function(e) {
        ...
        return n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = n.replace(/yyyy|YYYY/, t.getFullYear())).replace(/yy|YY/, t.getYear() % 100 > 9 ? (t.getYear() % 100).toString() : "0" + t.getYear() % 100)).replace(/MM/, t.getMonth() > 9 ? t.getMonth() + 1 : "0" + (t.getMonth() + 1))).replace(/M/g, t.getMonth())).replace(/w|W/g, a[t.getDay()])).replace(/dd|DD/, t.getDate() > 9 ? t.getDate().toString() : "0" + t.getDate())).replace(/d|D/g, t.getDate())).replace(/hh|HH/, t.getHours() > 9 ? t.getHours().toString() : "0" + t.getHours())).replace(/h|H/g, t.getHours())).replace(/mm/, t.getMinutes() > 9 ? t.getMinutes().toString() : "0" + t.getMinutes())).replace(/m/g, t.getMinutes())).replace(/ss|SS/, t.getSeconds() > 9 ? t.getSeconds().toString() : "0" + t.getSeconds())).replace(/s|S/g, t.getSeconds());
